...
export default function Pokemon() {
    ...
    return (<>
        ...
        <div className="row mt-4">
            <label className="col-sm-3 col-form-label">몬스터명 <FaAsterisk className="text-danger"/></label>
        ...
        <div className="row mt-4">
            <label className="col-sm-3 col-form-label">몬스터속성 <FaAsterisk className="text-danger"/></label>
            <div className="col-sm-9">
