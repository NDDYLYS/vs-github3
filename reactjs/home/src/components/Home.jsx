...
export default function Home() {
    ...
    return (
        <>
            <Jumbotron subject="KH 정보교육원 수업자료" detail="React 수업자료(bootstrap)"></Jumbotron>

            <div className="row mt-4">
                <div className="col-md-6 mb-4">
                    <div className="d-flex justify-content-between">
                        <h3>최근 게시글</h3>
                        <Link to="#" className="link-underline link-underline-opacity-0">더보기<i className="fa-solid fa-arrow-right"></i></Link>
                    </div>
                    <hr></hr>
                    ...
                    <ul className="list-group list-group-flush">
                        <li className="list-group-item d-flex justify-content-between">
                            ...
                            <div className="text-end">
                                ...
                                <span className="ms-1">702</span>
                            </div>
                        </li>
                        <li className="list-group-item d-flex justify-content-between">
                            <div className="text-start">
                                <span className="badge text-bg-secondary">2</span>
                                <span className="ms-4">라이츄</span>
                            </div>
                            <div className="text-end">
                                <i className="fa-solid fa-heart text-danger"></i>
                                <span className="ms-1">568</span>
                            </div>
                        </li>
                        <li className="list-group-item d-flex justify-content-between">
                            <div className="text-start">
                                <span className="badge text-bg-secondary">3</span>
                                <span className="ms-4">뮤츠</span>
                            </div>
                            <div className="text-end">
                                <i className="fa-solid fa-heart text-danger"></i>
                                <span className="ms-1">277</span>
                            </div>
                        </li>
                        <li className="list-group-item d-flex justify-content-between">
                            <div className="text-start">
